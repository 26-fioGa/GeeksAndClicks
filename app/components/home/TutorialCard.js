...
const TutorialCard = ({ titulo, contenido, imagen }) => {
  const navigation = useNavigation();

    return (
        <View>
            <TouchableOpacity onPress={()=> navigation.navigate('TutorialDetalle', {titulo: titulo, contenido: contenido, imagen: imagen})}>
